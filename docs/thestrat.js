...
{
    // Main Meta
    const TREASURY_TOKEN_TICKER = "theSTRAT";
    const TREASURY_TOKEN_NAME = "thestrat.mclb.org";
    const TREASURY_TOKEN_LONGNAME = "Thena Strategy";
	...
	const TADATA = [
		...
		[
			...
			0.000252,
			1000*(	0 ),
			1000*(	(13_114_452 -8_003_583)*0.01235/1000 + 4 ) ,
			1000*(	0  ) ,
			1_000_000_000 - 611_919_883
		],
